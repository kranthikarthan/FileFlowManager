...
export const loginRequest = {
  scopes: ['User.Read', 'api://fileflow-api/FileFlow.Read', 'api://fileflow-api/FileFlow.Write'],
};
...
/**
 * Add here the scopes for the API you want to call
 */
export const apiConfig = {
  apiBaseUrl: process.env.REACT_APP_API_BASE_URL || 'http://localhost:8080/api',
  scopes: ['api://fileflow-api/FileFlow.Read', 'api://fileflow-api/FileFlow.Write'],
};