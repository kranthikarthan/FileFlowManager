...
public class SubServiceConfiguration {
    ...
    @ElementCollection
    @CollectionTable(name = "sub_service_file_type_configs", 
                    joinColumns = @JoinColumn(name = "sub_service_config_id"))
    @MapKeyEnumerated(EnumType.STRING)
    @Column(name = "schema_id")
    private Map<FileType, Long> fileTypeSchemaMap;
    ...
    public Map<FileType, Long> getFileTypeSchemaMap() { return fileTypeSchemaMap; }
    public void setFileTypeSchemaMap(Map<FileType, Long> fileTypeSchemaMap) { this.fileTypeSchemaMap = fileTypeSchemaMap; }
    ...
    public Long getSchemaIdForFileType(FileType fileType, TransferDirection direction) {
        ...
        return fileTypeSchemaMap != null ? fileTypeSchemaMap.get(fileType) : null;
    }
